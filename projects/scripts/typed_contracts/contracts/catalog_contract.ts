...
import ABI from '../../../contract/catalog_contract.json';
import QueryMethods from '../query/catalog_contract';
import BuildExtrinsicMethods from '../build-extrinsic/catalog_contract';
import TxSignAndSendMethods from '../tx-sign-and-send/catalog_contract';
import MixedMethods from '../mixed-methods/catalog_contract';
import EventsClass from '../events/catalog_contract';
